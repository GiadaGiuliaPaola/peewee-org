...
# def create_table():
#     with database:
#         database.create_table([models.Ingredient, models.Restaurant, models.Dish, models.Rating])
...
if __name__ == "__main__":
    ...
    # # Create or delete the database based on user input
    # action = input("Enter 'create' to create the database or 'delete' to delete it: ").strip().lower()
